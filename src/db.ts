...
import { likePostSchema, newLikeModelType} from "./types/db-schemas/likePost-schema"
...
export const LikePostsNewest = mongoose.model<postLikeDbType,newLikeModelType>("newestLikes",likePostSchema)
